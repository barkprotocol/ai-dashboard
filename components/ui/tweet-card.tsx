...
// Twitter and Verified icon components
const Twitter = ({ className, ...props }: { className?: string; [key: string]: any }) => (
  <svg
    stroke="currentColor"
    fill="currentColor"
    strokeWidth="0"
...
const Verified = ({ className, ...props }: { className?: string; [key: string]: any }) => (
...
// TweetCard component (Server Side Only)
export const TweetCard = async ({
  ...
  return (
    <Suspense fallback={fallback}>
      <MagicTweet tweet={tweet} {...props} components={components} />
    </Suspense>
  )
}
